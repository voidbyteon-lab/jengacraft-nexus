...
export const ProductShowcase = () => {
  ...
  return (
    <section ref={ref} className="py-20 relative overflow-hidden bg-gradient-to-b from-minecraft-dark via-minecraft-darker to-black">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-minecraft-grass/20 rounded-lg blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white font-pixel">
            CONHEÇA O <span className="text-minecraft-grass">JENGA</span> x{" "}
            <span className="text-minecraft-redstone">MINECRAFT</span>
          </h2>
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-minecraft-darker to-black p-2 rounded-2xl overflow-hidden">
            <img
              src={productImage}
              alt="Jenga x Minecraft - Torre Pixelada com Base Redstone e App JengaCraft"
