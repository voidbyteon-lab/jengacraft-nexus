...
export const PreOrderSection = () => {
  ...
  const features = ["54 blocos temáticos Minecraft", "Base Altar de Redstone com sensores", "Feedback háptico inteligente", "Conectividade Bluetooth/Wi-Fi", "App JengaCraft incluído", "Materiais eco-friendly"];
  return <section id="pre-order" className="py-20 bg-gradient-to-b from-background to-muted" ref={ref}>
