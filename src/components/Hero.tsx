    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.h1
              className="text-pixel text-3xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight"
            ...
            >
              <Button
                ...
                className="bg-accent hover:bg-accent/90 text-white redstone-glow text-lg px-8 shake-on-hover"
              >
                PRÉ-VENDA AGORA!
              </Button>
              <Button
